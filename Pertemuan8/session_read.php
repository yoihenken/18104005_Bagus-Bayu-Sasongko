...
<body>
    ...
    <a href="session_process.php? process=hapus_session1"><button>Delete Session 1</button> </a> <br>
    <a href="session_process.php? process=hapus_session2"><button>Delete Session 2</button> </a> <br>
    <a href="session_process.php? process=hapus_semua_session"><button>Delete All Session</button></a> <br>
